...
parser = None       #helps to parse the output in structured format, global input
st.set_page_config(layout="wide")

# load css file
def local_css(file_name):
    with open(file_name) as f:      #with ensures file is closed after reading
        st.markdown(f"<style>{f.read()}</style>", unsafe_allow_html=True)
local_css("styles.css")

#pydantic is used for data validation making easy to write error free code
#used to define structure of data 
#basemodel is the core class used to create own data model
